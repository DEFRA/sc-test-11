...
```bash
docker build --target development --no-cache --tag sc-test-11:development .
```

Run:

```bash
docker run -p 3000:3000 sc-test-11:development
```
...
```bash
docker build --no-cache --tag sc-test-11 .
```

Run:

```bash
docker run -p 3000:3000 sc-test-11
```
